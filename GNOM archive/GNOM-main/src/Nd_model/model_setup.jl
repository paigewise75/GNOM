...
@initial_value @units @flattenable @limits @description struct Params{Tp} <: AbstractParameters{Tp}
    ...
    β_EAsia_dust::Tp   |    5.0  | per100       | false |  (0,100) | "EAsia dust Nd solubility"
    β_NEAf_dust::Tp    |    5.0  | per100       | false |  (0,100) | "NEAf dust Nd solubility"
    β_NWAf_dust::Tp    |    5.0  | per100       | false |  (0,100) | "NWAf dust Nd solubility"
    β_NAm_dust::Tp     |    5.0  | per100       | false |  (0,100) | "NAm dust Nd solubility"
    β_SAf_dust::Tp     |    5.0  | per100       | false |  (0,100) | "SAf dust Nd solubility"
    β_SAm_dust::Tp     |    5.0  | per100       | false |  (0,100) | "SAm dust Nd solubility"
    β_MECA_dust::Tp    |    5.0  | per100       | false |  (0,100) | "MECA dust Nd solubility"
    β_Aus_dust::Tp     |    5.0  | per100       | false |  (0,100) | "Aus dust Nd solubility"
    β_Sahel_dust::Tp   |    5.0  | per100       | false |  (0,100) | "Sahel dust Nd solubility"
    ...
    w₀_bSi::Tp         |  714.0  | m/d          | false |   (0,∞)  | "Settling velocity of bSi-scavenged Nd"
    K_dust::Tp         | 1.7e-3  | (g/m^3)^-1   | true  |   (0,∞)  | "Dust-scavenging reaction constant"
