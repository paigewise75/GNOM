...
@initial_value @units @flattenable @limits @description struct Params{Tp} <: AbstractParameters{Tp}
    ...
    β_EAsia_dust::Tp   |    2.0 | per100       | true  |  (0,100) | "EAsia dust Nd solubility"
    β_NEAf_dust::Tp    |    2.0 | per100       | true  |  (0,100) | "NEAf dust Nd solubility"
    β_NWAf_dust::Tp    |    2.0 | per100       | true  |  (0,100) | "NWAf dust Nd solubility"
    β_NAm_dust::Tp     |    2.0 | per100       | true  |  (0,100) | "NAm dust Nd solubility"
    β_SAf_dust::Tp     |    2.0 | per100       | true  |  (0,100) | "SAf dust Nd solubility"
    β_SAm_dust::Tp     |    2.0 | per100       | true  |  (0,100) | "SAm dust Nd solubility"
    β_MECA_dust::Tp    |    2.0 | per100       | true  |  (0,100) | "MECA dust Nd solubility"
    β_Aus_dust::Tp     |    2.0 | per100       | true  |  (0,100) | "Aus dust Nd solubility"
    β_Sahel_dust::Tp   |    2.0 | per100       | true  |  (0,100) | "Sahel dust Nd solubility"
    ε_volc::Tp         |    5.4 | per10000     | true  |(2.7,8.0) | "Volcanic ash εNd"
    β_volc::Tp         |    2.0 | per100       | true  |  (0,100) | "Volcanic ash Nd solubility"
