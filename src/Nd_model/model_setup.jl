...
@initial_value @units @flattenable @limits @description struct Params{Tp} <: AbstractParameters{Tp}
    ...
    ϕ_0::Tp            |     0.0 | pmol/cm^2/yr | false |   (0,∞)  | "Sedimentary flux at surface"
    ϕ_∞::Tp            |    14.0 | pmol/cm^2/yr | true  | (10,50)  | "Sedimentary flux at infinite depth"
    z_0::Tp            |  2000.0 | m            | false |   (0,∞)  | "Sedimentary flux depth attenuation"
...
const groundwater_injection_invsec = let
    GROUNDWATERS = GroundWaters.load() # load the geographic locations and discharge of groundwater (in m³ yr⁻¹) from the Luijendijk et al. (2020)) dataset
