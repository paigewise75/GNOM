...
@initial_value @units @flattenable @limits @description struct Params{Tp} <: AbstractParameters{Tp}
    ...
    ϕ_0::Tp            |    40.0 | pmol/cm^2/yr | false |   (0,∞)  | "Sedimentary flux at surface"
    ϕ_∞::Tp            |     0.0 | pmol/cm^2/yr | false |   (0,∞)  | "Sedimentary flux at infinite depth"
    z_0::Tp            |   300.0 | m            | false |   (0,∞)  | "Sedimentary flux depth attenuation"
